...
export const siteConfig: SiteConfig = {
	title: "Kehao Zheng's Website",
	subtitle: "",
	siteURL: "https://kehaozheng.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"I'm a CS PhD Student at USU",
				"My focus is AI & Blockchain",
...
export const profileConfig: ProfileConfig = {
	...
	name: "Kehao Zheng",
	bio: "Click the avatar to see more info",
	typewriter: {
	...
	links: [
		{
			...
			url: "https://x.com/alakdksj",
		},
		{
			name: "LinkedIn",
			icon: "fa6-brands:linkedin",
			url: "https://www.linkedin.com/in/kevin-zheng-0333502b7/",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/ARIS2333",
		},
		{
			name: "Instagram",
			icon: "fa6-brands:instagram",
			url: "https://www.instagram.com/kale200310/",
		},
		{
			name: "Youtube",
			icon: "fa6-brands:youtube",
			url: "https://www.youtube.com/@Kitasang-vg4pz",
		}
	],
};
