...
- [**1. What Is a System Transaction?**](#1-what-is-a-system-transaction)
- [**2. Execution Semantics**](#2-execution-semantics)
- [**3. Implementation**](#3-implementation--process_system_transaction)
- [**4. Checked vs. Unchecked Variants**](#4-checked-vs-unchecked-variants)
- [**5. System Contracts in Osaka**](#5-system-contracts-in-osaka)
- [**6. Block-Level Execution Order**](#6-block-level-execution-order--apply_body)
- [**7. EL → CL Requests**](#7-el--cl-requests-eip-7685)
- [**8. Deposit Requests**](#8-deposit-requests-eip-6110)
- [**9. Withdrawal Requests**](#9-withdrawal-requests-eip-7002)
- [**10. Consolidation Requests**](#10-consolidation-requests-eip-7251)
- [**11. Request Hashing**](#11-request-hashing--compute_requests_hash)
- [**12. Block Header Commitment**](#12-block-header-commitment)
